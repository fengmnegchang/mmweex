...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/6ef7a3a3c07670025b576c5b1ad2f5c1', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/6ef7a3a3c07670025b576c5b1ad2f5c1',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/footgrid_item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	      ...
	      "children": [
	        {
	          "type": "div",
	          "repeat": {
	            "expression": function () {return this.tag},
	            "value": "t"
	          },
	          "events": {
	            "click": function ($event) {this.towebdetail(this.t.href,$event)}
	          },
	          "classList": [
	            "tag"
	          ],
	          "children": [
	            {
	              ...
	              "attr": {
	                "src": function () {return this.t.src}
	              }
	            },
	            {
	              "type": "text",
	              ...
	              "attr": {
	                "value": function () {return this.t.alt}
	              }
	            }
	          ]
	        }
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            var self = this;
	            weexJsoupModule.footgrid(self.taghref, function (e) {
	                self.refresh_display = 'hide';
	                self.showLoading = 'hide';
	                self.refreshing = "false";
	                var result = (0, _stringify2.default)(e);
	                console.log('bodytag==' + result);
	                var json;
	                json = eval('(' + e + ')');
