...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/a2d129d4e5fd99219270d5a1f340fedd', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/a2d129d4e5fd99219270d5a1f340fedd',undefined,undefined)
	...
	module.exports = {
	    ...
	    methods: {
	        refresh: function refresh() {
	            var self = this;
	            weexJsoupModule.tagtab(yoka.getfashionfoottag(), function (e) {
	                var json;
	                json = eval('(' + e + ')');
	                    ...
	                    if (json.list && json.list.length > 0) {
	                        for (var i = 0; i < json.list.length; i++) {
	                            ...
	                            var tab = {
	                                ...
	                                src: yoka.getPathUrl('box/boxlist.js', false),
	                                visibility: 'visible',
	                                taghref: tag.href
	                            };
	                            if (i == 0) {
