...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/f1bb43a294c8ff05cd0593edb8fb52eb', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/f1bb43a294c8ff05cd0593edb8fb52eb',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(38)(IteratorPrototype, __webpack_require__(111)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pc_main_image_head_item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": function () {return (this.tag.id) + ' ' + (this.tag.alt)}
	          }
	        }
	      ]
	    },
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            var self = this;
	            weexJsoupModule.pcmainfoot(self.href, function (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pc_main_image_grid_item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	  ...
	  "children": [
	    {
	      ...
	      "events": {
	        "click": function ($event) {this.towebdetail(this.gridtag.href,$event)}
	      },
	      "children": [
	        {
	          "type": "text",
	          "classList": function () {return ['tucao_numClass', 'textClass-' + (this.skinType)]},
	          "attr": {
	            "value": function () {return this.gridtag.alt}
	          }
	        },
	        {
	          "type": "image",
	          ...
	          "attr": {
	            "src": function () {return this.gridtag.src}
	          }
	        }
	      ]
	    },
	    {
	      ...
	      "events": {
	        "click": function ($event) {this.towebdetail(this.gridtag.href2,$event)}
	      },
	      "children": [
	        {
	          "type": "text",
	          "classList": function () {return ['tucao_numClass', 'textClass-' + (this.skinType)]},
	          "attr": {
	            "value": function () {return this.gridtag.alt2}
	          }
	        },
	        {
	          "type": "image",
	          ...
	          "attr": {
	            "src": function () {return this.gridtag.src2}
	          }
	        }
	      ]
	    },
	      ...
	      "children": [
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.gridtags},
	            "value": "gridtag"
	          },
	          "children": [
	            {
	              "type": "pc_main_image_grid_item",
	              "attr": {
	                "gridtag": function () {return this.gridtag}
	              }
	            }
	          ]
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pc_main_image_list_item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pc_main_image_grid', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": function () {return (this.tag.alt) + ' ' + (this.tag.href)}
	          }
	        },
	        {
	          "type": "pc_main_image_grid",
	          "attr": {
	            "gridtags": function () {return this.getGrids(this.tag.list)}
	          }
	        }
	      ]
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        towebdetail: function towebdetail() {
	            var self = this;
	            var href = self.tag.href;
	            weexEventModule.startWebViewActivity(href);
	        },
	        getGrids: function getGrids(tags) {
	            var gridtags = [];
	            var self = this;
	            for (var i = 0; i < tags.length; i += 2) {
	                ...
	                console.log('gridtag===' + (0, _stringify2.default)(gridtag));
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pc_main_image_head', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pc_main_image_foot', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            ...
	            weexJsoupModule.pcmainimagelist(param, function (e) {
	                self.refresh_display = 'hide';
	                self.showLoading = 'hide';
	                self.refreshing = "false";
	                var json;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pcmainheadpager', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    "src": function () {return this.item.dataimg}
	  },
	  "events": {
	    "click": "towebdetail"
	  }
